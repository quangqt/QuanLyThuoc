		...
		<div class="row-fluid">
			...
			<div id="content" class="span10">
				<ul class="breadcrumb">
					...
					<li><i class="icon-edit"></i> <a href="#">Chỉnh sửa Loại
							sản phẩm</a></li>
				</ul>
				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							...
							<form method="post"
								action="${pageContext.request.contextPath}/ManagerCategory?command=edit" class="form-horizontal">
								<input type="hidden" name="maloai" value ="${category.maLoai }"/>
								<fieldset>
									<div class="control-group">
