				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							...
							<form method="post"
								action="${pageContext.request.contextPath}/ManagerProduct?command=create"
								...
								<fieldset>
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="span6 typeahead" name="tensp"
												...
												value="${product.tenSp}" maxlength="100" />
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="span6 typeahead" name="title"
												data-provide="typeahead" data-items="4"
												value="${product.chude }" maxlength="50" />
										</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label" for="appendedInput">Xuất
											xứ</label>
										<div class="controls">
											<div class="input-append">
									...
									<div class="control-group hidden-phone">
										...
										<div class="controls">
											<textarea class="cleditor" name="mota" rows="3"
